...
PEAK_BATCH_SIZE = 256         # Larger batch size for handling class imbalance
PEAK_EPOCHS = 50              # Fewer epochs for faster training
PEAK_EARLY_STOPPING_PATIENCE = 10
...
VALLEY_EPOCHS = 20            # Increased epochs for better learning with recall loss
